...
void R_TAU0_Channel2_Start(void)
{
    ...
    TOE0 |= _0008_TAU_CH3_OUTPUT_ENABLE | _0010_TAU_CH4_OUTPUT_ENABLE;
    TS0 |= _0004_TAU_CH2_START_TRG_ON | _0008_TAU_CH3_START_TRG_ON | _0010_TAU_CH4_START_TRG_ON;
}
...
{
    TT0 |= _0004_TAU_CH2_STOP_TRG_ON | _0008_TAU_CH3_STOP_TRG_ON | _0010_TAU_CH4_STOP_TRG_ON;
    TOE0 &= ~_0008_TAU_CH3_OUTPUT_ENABLE & ~_0010_TAU_CH4_OUTPUT_ENABLE;
    /* Mask channel 2 interrupt */
    TMMK02 = 1U;    /* disable INTTM02 interrupt */
    TMIF02 = 0U;    /* clear INTTM02 interrupt flag */
